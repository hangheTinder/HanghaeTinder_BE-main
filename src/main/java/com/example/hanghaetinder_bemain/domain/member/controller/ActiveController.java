...
public class ActiveController {
	...
	public void likeUsers (@PathVariable final Long userId, @AuthenticationPrincipal final UserDetailsImpl userDetails, final HttpServletResponse response){
		try {
	...
	public void dislikeUsers (@PathVariable final Long userId, @AuthenticationPrincipal final UserDetailsImpl userDetails, final HttpServletResponse response){
		try {
